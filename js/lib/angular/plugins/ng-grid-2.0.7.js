define(['jquery', 'app/util'], function($){
/***********************************************
...
(function(window, $) {
    ...
    angular.module('ngGrid.services').factory('$domUtilityService', ['$utilityService',
        function($utils) {
                    ...
                    return {
                        pre: function($scope, iElement) {
                            if (iElement.children().length === 0) {
                                ...
                                var toolbars = $scope.gridOption.toolbars || [];
                                angular.forEach(toolbars.reverse(), function(value, key) {
                                    var ngClick = value.id + 'ngClick',
                                        ngDisabled = value.id + 'ngDisabled',
    ...
    angular.module("ngGrid").run(["$templateCache",
        function($templateCache) {
            ...
            $templateCache.put("menuTemplate.html",
                ...
                "</div>" +
                "<div ng-show=\"showMenu\" class=\"ngColMenu colSelector\">" +
