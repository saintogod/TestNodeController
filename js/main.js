require.config({
    ...
    paths: {
        ...
        jqueryui: 'lib/jquery/plugins/jquery-ui/jquery-ui.custom',
...
require(['jquery', 'angular', 'app/init', 'modernizr', 'bootstrap'], function($, angular, init, modernizr) {
    'use strict';
